...
private const val NEW_TASKS_NOTIFICATION_ID = 312
...
fun showTriggerNotification(alarmItem: AlarmItem) {
  ...
  val notification = notificationBuilder
      ...
      .build()
  notificationManager.notify(NEW_TASKS_NOTIFICATION_ID, notification)
}